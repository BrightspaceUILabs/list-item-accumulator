...
const sauceLabsCapabilities = {
	name: '@brightspace-ui-labs/list-item-accumulator unit tests',
	// eslint-disable-next-line no-undef
	build: `@brightspace-ui-labs/list-item-accumulator ${process.env.GITHUB_REF ?? 'local'} build ${process.env.GITHUB_RUN_NUMBER ?? ''}`
};
