...
class DemoListItemUsage extends LitElement {
	...
	render() {
		return html`
			<d2l-list grid drag-multiple @d2l-list-item-position-change="${this._moveItems}">
...
customElements.define('d2l-demo-list-item', DemoListItemUsage);
